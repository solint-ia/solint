    ...
    >
      ...
      <Reveal delay={0.1} className="relative">
        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          {platformSection.capabilities.map((capability) => {
            ...
            return (
              <div
                ...
                className={`group relative flex flex-col justify-between rounded-2xl p-5.5 transition-all duration-300 hover:-translate-y-1 ${
                  isHighlight
