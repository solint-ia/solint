...
- **Prospect** — hero com pipeline vertical, fluxo em S de 6 etapas com espinha luminosa contínua e arcos de conexão, painel de destino com progressão de status (Identificado → Qualificado → Interesse confirmado → Pronto para fechar), faixa clara "Plataforma".
